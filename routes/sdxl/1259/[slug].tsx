...
export const handler: Handlers<Page> = {
    async GET(_req: Request, ctx: HandlerContext) {
        const realPath = Deno.cwd() + "/content/sdxl/1259/" + ctx.params.slug;
        try {
            const txt = await Deno.readTextFile(realPath);
            const html = await getHTMLString(txt, "Pendekar Rajawali - " + ctx.params.slug);
            ...
            console.log(`Slug handler for sdxl: ${err}`);
