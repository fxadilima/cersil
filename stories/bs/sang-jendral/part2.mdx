...
<img src="/images/buku-3/ma-xiuying-menangis.png"
    alt="Zhao Min & Zhou Zhiruo menghibur Ma Xiuying"
    title="Ma Xiuying menangis sambil menceritakan apa yang terjadi kepada Zhao Min dan Zhou Zhiruo"
...
<div class="text-center">
    <div class="btn-group">
        <a class="btn btn-primary" 
            href="/linear-pages/sang-jendral/parts/part1"><i class="fas fa-arrow-left"></i> Prev</a>
        <a class="btn btn-primary" href="/linear-pages/sang-jendral"><i class="fas fa-home"></i></a>
        <a class="btn btn-primary" 
            href="/linear-pages/sang-jendral/parts/part3">Next <i class="fas fa-arrow-right"></i></a>
    </div>
</div>
