...
<a class="btn" 
    ...
    data-bs-target="#songshan-1355">
    <img src="/images/tiny/zhang-wuji.jpg"
        alt="Zhang Wuji" 
        title="Zhang Wuji" 
...
<div id="songshan-1355" class="collapse show">

## Henan, 1355
### *Alfa Dan Omega*


Zhang Wuji menggigil. Ia tak tahu kenapa. Ia merasa, malam ini ada yang sedang memikirkan dirinya dari tempat yang sangat jauh.

Sementara mereka bertiga termangu-mangu mengamati punggung Yin Li hingga menghilang di balik pepohonan dan gelapnya malam nan dingin, tiba-tiba seraut wajah cantik melintas di benaknya.

Ia lalu berusaha menepisnya, "Di tengah malam buta, aku tiba-tiba memikirkan dirinya?" Lalu ia mengalihkan pikirannya ke ayah angkatnya.
...
<a class="collapsed btn" 
    data-bs-toggle="collapse" 
    data-bs-target="#alamut-1355">
    <img src="/images/tiny/xiao-zhao-front.jpg"
        alt="Xiao Zhao" 
        title="Xiao Zhao" 
        style="max-height:120px"
    />
...
<div id="alamut-1355" class="collapse">
...
<div class="text-center">
    <div class="btn-group">
        <a class="btn btn-primary" 
            href="/linear-pages/sang-jendral/parts/prolog"><i class="fas fa-arrow-left"></i> Prev</a>
        <a class="btn btn-primary" href="/linear-pages/sang-jendral"><i class="fas fa-home"></i></a>
        <a class="btn btn-primary" 
            href="/linear-pages/sang-jendral/parts/part2">Next <i class="fas fa-arrow-right"></i></a>
    </div>
</div>
